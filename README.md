...
**Всички права запазени.** Виж [LICENSE](LICENSE).

Кодът е публичен, за да може да бъде разгледан и оценен. Публичната видимост не
дава право на ползване: копирането, променянето, разпространяването и ползването
— търговско или нетърговско, включително в училище — изискват писмено разрешение
от автора.

До 6 септември 2026 г. проектът беше под лиценз MIT. Това разрешение остава
валидно за копията, получени под него преди тази дата, и не важи за версиите
след нея.
